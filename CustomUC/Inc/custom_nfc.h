/**
  ...
  * @version 1.0.0
  * @brief   This file contains definitions for the bsp custom_nfc.c
  *          specific functions.
  ******************************************************************************
  * @attention
  *
...
#ifndef __CUSTOM_NFC_H
#define __CUSTOM_NFC_H
...
/* Exported macro ------------------------------------------------------------*/
/* Exported function	--------------------------------------------------------*/
/** @defgroup SMARTNFC_NFCTAG_Exported_Functions
  * @{
  */
