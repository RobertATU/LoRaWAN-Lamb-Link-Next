...
#ifndef STEVAL_ASTRA1B_CONF_H
#define STEVAL_ASTRA1B_CONF_H
...
/** @defgroup STEVAL_ASTRA1B_CONFIG Config
  * @{
  */

/** @defgroup STEVAL_ASTRA1B_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
