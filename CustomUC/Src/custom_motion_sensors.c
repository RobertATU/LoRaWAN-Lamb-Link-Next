...
static int32_t LSM6DSO32X_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.Address     = LSM6DSO32X_I2C_ADD_H; /* SA0 = VDD */
  io_ctx.Init        = CUSTOM_LSM6DSO32X_0_I2C_Init;
  io_ctx.DeInit      = CUSTOM_LSM6DSO32X_0_I2C_DeInit;
  io_ctx.ReadReg     = CUSTOM_LSM6DSO32X_0_I2C_ReadReg;
  io_ctx.WriteReg    = CUSTOM_LSM6DSO32X_0_I2C_WriteReg;
  ...
  else if (id != (uint8_t)LSM6DSO32X_ID)
  {
    ret = BSP_ERROR_UNKNOWN_COMPONENT;
  }
  else
  {
    ...
    MotionCtx[CUSTOM_LSM6DSO32X_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[CUSTOM_LSM6DSO32X_0] = &lsm6dso32x_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[CUSTOM_LSM6DSO32X_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSO32X_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[CUSTOM_LSM6DSO32X_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSO32X_GYRO_Driver;

      if (MotionDrv[CUSTOM_LSM6DSO32X_0]->Init(MotionCompObj[CUSTOM_LSM6DSO32X_0]) != LSM6DSO32X_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[CUSTOM_LSM6DSO32X_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSO32X_ACC_Driver;
